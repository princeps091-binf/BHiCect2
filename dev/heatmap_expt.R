...
# %%
plot_exhaustive_locked_split <- function(node_id, summary_tbl, MresFile) {
...
HCT116_summary_tbl|>filter(size > 20)|>arrange((res_level))|>dplyr::select(id,res_level,size,perf,depth)
tmp_node = "D6_R6_30_17500000_24750000"
